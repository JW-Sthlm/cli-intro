...
The full partner-flavored course is published at **https://jw-sthlm.github.io/cli-intro-share/course/** (alongside the setup page). Eight self-paced lessons; first five for everyone, last three optional and a bit more technical. Use it for async learning instead of (or after) the live workshop.
